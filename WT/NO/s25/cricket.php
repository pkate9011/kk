...
$cricketTeam = $doc->createElement("CricketTeam");// Create the first team element for Australia
...
// Create the runs element and set its value$runs2 = $doc->createElement("runs", "12169");
